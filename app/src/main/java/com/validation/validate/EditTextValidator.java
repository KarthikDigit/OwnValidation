...
public abstract class EditTextValidator<T extends TextInputLayout> extends Validator<T> {
    public EditTextValidator(T view, String errorMessage) {
        super(view, errorMessage);
    }


//    public EditTextValidator(T view, int errorMessageId) {
